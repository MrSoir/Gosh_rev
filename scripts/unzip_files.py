...
class UnZipFiles(Worker):
    def __init__(self, absTarZipFilePath, tarExtractDir, pwd=None, progress_dialog=None):
        super().__init__(progress_dialog)
        print('in UnZipFiles-constructor!')
        
        self.absTarZipFilePath = absTarZipFilePath
        self.tarExtractDir = tarExtractDir
        self.pswrd = pwd
...
#    parser.add_argument("-b", "--base_dir", help="base-target-directory: destination folder to copy files to")
    ...
    parser.add_argument("-t", "--target", help="target dir: the files will be extracted to this directory", required=True)
